...
$string['postaddedsuccessbyuser'] = 'Post has been send for Admin approval.Please wait some time.';
...
$string['invalidforumid'] = 'Invalid Forum Id';

$string['request_confirm'] = 'Your subscription request has been sent to admin for approval';
$string['subscription_confirm'] = 'User has been successfully subscribed';
$string['slno'] = 'SL No.';
$string['action'] = 'Action';
$string['forumname'] = 'Forum';
$string['user'] = 'Users';
$string['delete_confirm'] = 'User has been unsubscribed';