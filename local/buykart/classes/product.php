...
class BuykartProduct {

	/**
	 * The Buykart product id
	 * @var int
	 */
	protected $_id;
	...
	public function load($id){
		...
		$query = sprintf(
			'SELECT 
				...
				tags,
				timecreated
			FROM {local_buykart_product} lmp, {course} c
	...
	public function get_related($limit = 3){
		...
		return local_buykart_get_random_products($limit, $this->_categoryid, $this->_id);
	}
	...
	/**
	 * Retrieves the BuykartProduct id
	 * @return int    id
	 */
