...
class moodec_transaction_table extends table_sql {
    ...
    function __construct($uniqueid) {
        ...
        $headers = array(
            get_string('transaction_field_date', 'local_buykart')    ,   // 'Date'
            get_string('transaction_field_id', 'local_buykart'),         // 'Transaction ID',
            get_string('transaction_field_user', 'local_buykart'),       // 'User',
            get_string('transaction_field_amount', 'local_buykart'),     // 'Amount',
            get_string('transaction_field_items', 'local_buykart'),      // 'Number of items',
            get_string('transaction_field_gateway', 'local_buykart'),    // 'Gateway',
            get_string('transaction_field_txn', 'local_buykart'),
            get_string('transaction_field_status', 'local_buykart'),     // 'Status',
            get_string('transaction_field_actions', 'local_buykart'),     // 'Action'
        );
    ...
    function col_amount($values) {
        ...
        return local_moodec_get_currency_symbol(get_config('local_buykart', 'currency')) . number_format($t->get_cost(), 2, '.', ',');
    }
    ...
    function col_actions($values) {
        ...
        $url = new moodle_url(
            $CFG->wwwroot .'/local/buykart/pages/transaction/view.php', 
            array( 'id' => $values->id )
        );
        ...
        if ($this->is_downloading()) {
            ...
            return sprintf(
                '<a href="%s">%s</a>',
                $url,
                get_string('transaction_view_label', 'local_buykart')
            );
        }
    }
    ...
    function print_nothing_to_display() {
        ...
        printf(
            ...
            get_string('transaction_table_empty', 'local_buykart')
        );
    }
}