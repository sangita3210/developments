...
class BuykartProductVariable extends BuykartProduct {

	/**
	 * Stores an array of BuykartProductVariation instances
	 * @var array
	 */
    ...
    public function load($id) {
    	...
    	if(!!$productVariations) {
	    	foreach ($productVariations as $pv) {
	    		...
	    		$this->_variations[$variationid] = new BuykartProductVariation($variationid, true);
	    	}
	    } else {
     ...
     * @return BuykartProductVariation     		Either the specific variation
     */
