...
class BuykartTransactionItem {
	...
	private function load($id) {
		...
		$record = $DB->get_record('local_buykart_trans_item', array('id' => $id));
	...
	public function create($transactionId, $product, $cost, $variation = 0){
		...
		$this->_id = $DB->insert_record('local_buykart_trans_item', $newRecord, true);

		return $this->_id;
	}

	/**
	 * Returns this BuykartTransactionItem is
	 * @return int id
	 */
