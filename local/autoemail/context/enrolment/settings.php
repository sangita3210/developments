...
if ($hassiteconfig) {
    ...
    //NewMentor manual course assignment
    $name = 'autoemailcontext_enrolment/message_new_mentor_subject';
    $default = get_string('default_new_mentor_email_subject', 'autoemailcontext_enrolment', $site->fullname);
    $title = get_string('message_new_mentor_subject', 'autoemailcontext_enrolment');
    $description = get_string('message_new_mentor_subject_desc', 'autoemailcontext_enrolment');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $settings->add($setting);

    
    $name = 'autoemailcontext_enrolment/message_new_mentor';
    $title = get_string('message_new_mentor', 'autoemailcontext_enrolment');
    $description = get_string('message_new_mentor_desc', 'autoemailcontext_enrolment');
    $setting = new admin_setting_confightmleditor($name, $title, $description, '');
    $settings->add($setting);
    ...
    // //self registration
    // $name = 'aautoemailcontext_enrolment/message_user_self_subject';
    // $default = get_string('default_user_self_email_subject', 'autoemailcontext_enrolment', $site->fullname);
    // $title = get_string('message_user_self_subject', 'autoemailcontext_enrolment');
    // $description = get_string('message_user_self_subject_desc', 'autoemailcontext_enrolment');
    // $setting = new admin_setting_configtext($name, $title, $description, $default);
    // $settings->add($setting);

    
    // $name = 'autoemailcontext_enrolment/message_user_self';
    // $title = get_string('message_user_self', 'autoemailcontext_enrolment');
    // $description = get_string('message_user_self_desc', 'autoemailcontext_enrolment');
    // $setting = new admin_setting_confightmleditor($name, $title, $description, '');
    // $settings->add($setting);

    ///course complete
    $name = 'aautoemailcontext_enrolment/message_user_coursecomplete_subject';
    $default = get_string('default_user_coursecomplete_email_subject', 'autoemailcontext_enrolment', $site->fullname);
    $title = get_string('message_user_coursecomplete_subject', 'autoemailcontext_enrolment');
    $description = get_string('message_user_coursecomplete_subject_desc', 'autoemailcontext_enrolment');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $settings->add($setting);

    
    $name = 'autoemailcontext_enrolment/message_user_coursecomplete';
    $title = get_string('message_user_coursecomplete', 'autoemailcontext_enrolment');
    $description = get_string('message_user_coursecomplete_desc', 'autoemailcontext_enrolment');
    $setting = new admin_setting_confightmleditor($name, $title, $description, '');
    $settings->add($setting);
