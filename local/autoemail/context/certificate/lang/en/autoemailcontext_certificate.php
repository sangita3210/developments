...
$string['usersettings'] = 'User certificate Settings';
...
$string['message_mentor_desc'] = 'Email send to new mentor';
...
<h3>Dear [[fullname]]</h3>
<p>You have successfully downloaded the certificate <<3>>of  the course, <<<2>>>.
Please find attached your certificate.</p>
<h4>Thank You.</h4>
